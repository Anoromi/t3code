...
layer("022_RepairForkedMigrationDrift", (it) => {
  it.effect(
    ...
    () =>
      ...
      `;
        ...
        assert.deepEqual(migrationRows, [
          ...
          { migrationId: 20, name: "ProjectionThreadsForkOriginCompat" },
          { migrationId: 21, name: "ProjectionProjectsWorktreeGroupTitles" },
          { migrationId: 22, name: "RepairForkedMigrationDrift" },
        ]);
      }),
  );
});
