...
layer("027_RepairForkedMigrationDrift", (it) => {
  it.effect(
    ...
    () =>
      ...
      `;
        ...
        assert.deepEqual(migrationRows, [
          { migrationId: 19, name: "ProjectionSnapshotLookupIndexes" },
          { migrationId: 20, name: "AuthAccessManagement" },
          { migrationId: 21, name: "AuthSessionClientMetadata" },
          { migrationId: 22, name: "AuthSessionLastConnectedAt" },
          { migrationId: 23, name: "ProjectionThreadShellSummary" },
          { migrationId: 24, name: "BackfillProjectionThreadShellSummary" },
          { migrationId: 25, name: "CleanupInvalidProjectionPendingApprovals" },
          { migrationId: 26, name: "ProjectionProjectsWorktreeGroupTitles" },
          { migrationId: 27, name: "RepairForkedMigrationDrift" },
        ]);
      }),
  );
});
