...
import Migration0033 from "./Migrations/033_ProjectionThreadsForkOrigin.ts";
import Migration0034 from "./Migrations/034_ProjectionProjectsHyprnavSettings.ts";
import Migration0035 from "./Migrations/035_NormalizeProjectHyprnavScopes.ts";
import Migration0036 from "./Migrations/036_RestoreInheritedProjectHyprnavNulls.ts";
import Migration0037 from "./Migrations/037_RepairProviderInstanceIdProjectionColumns.ts";
import Migration0038 from "./Migrations/038_RepairProjectionThreadLatestTurnIds.ts";
import Migration0039 from "./Migrations/039_ProviderSessionRuntimeIndexes.ts";
import Migration0040, {
  prepareForkMigrationPrerequisites,
} from "./Migrations/040_RepairForkMigrationCompatibility.ts";
import { hasForkMigrationLedger } from "./Migrations/038_RepairProjectionThreadLatestTurnIds.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadsForkOrigin", Migration0033],
  [34, "ProjectionProjectsHyprnavSettings", Migration0034],
  [35, "NormalizeProjectHyprnavScopes", Migration0035],
  [36, "RestoreInheritedProjectHyprnavNulls", Migration0036],
  [37, "RepairProviderInstanceIdProjectionColumns", Migration0037],
  [38, "RepairProjectionThreadLatestTurnIds", Migration0038],
  [39, "ProviderSessionRuntimeIndexes", Migration0039],
  [40, "RepairForkMigrationCompatibility", Migration0040],
] as const;
