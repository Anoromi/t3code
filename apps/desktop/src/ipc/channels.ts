...
export const TOGGLE_EXTERNAL_CORKDIFF_CHANNEL = "desktop:toggle-external-corkdiff";
export const OPEN_WORKTREE_TERMINAL_CHANNEL = "desktop:open-worktree-terminal";
export const LIST_OPEN_WORKTREE_TERMINALS_CHANNEL = "desktop:list-open-worktree-terminals";
...
export const FOCUS_APP_WINDOW_CHANNEL = "desktop:focus-app-window";
